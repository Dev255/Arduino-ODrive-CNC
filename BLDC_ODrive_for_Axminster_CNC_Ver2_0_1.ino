...
void loop(void) {
  ...
  if (menuSelect == 1) {
    keyPadEnabled = true;
    lcd1.setCursor(0, 0);
    lcd1.print("1:Circle Mill       ");
    lcd1.setCursor(0, 1);
    lcd1.print("2:                  ");
    lcd1.setCursor(0, 2);
    lcd1.print("3:Feature Mill      ");
    if(oDrive0m0CLC == false || oDrive0m1CLC == false){
      lcd1.setCursor(0, 3);
      lcd1.print("5:<>SftStop 6:Back");
    }else{
      lcd1.setCursor(0, 3);
      lcd1.print("5:<>SStp 6:CLC Off");
    }
  }
  ...
  if (menuSelect == 2) {
    keyPadEnabled = true;
    lcd1.setCursor(0, 0);
    lcd1.print("1:Clamp Holes 2:Base");
    lcd1.setCursor(0, 1);
    lcd1.print("3:MountHol 4:CableHl");
    lcd1.setCursor(0, 2);
    lcd1.print("5:YRtEncSlt  6:YSlt1");
    lcd1.setCursor(0, 3);
    lcd1.print("7:YSlt2     8:Return");
  }
  ...
  if (KeyPadRetrieve() == 1 && menuSelect == 2) {
    YBaseHoles(300000);
  }
  if (KeyPadRetrieve() == 2 && menuSelect == 2) {
    YAxisBase(32768);
  }
  if (KeyPadRetrieve() == 3 && menuSelect == 2) {
    YBaseMountHoles(300000);
  }
  if (KeyPadRetrieve() == 4 && menuSelect == 2) {
    YMotCblHle(32768);
  }
  if (KeyPadRetrieve() == 5 && menuSelect == 2) {
    YRotEncSlot(32768);
  }
  if (KeyPadRetrieve() == 6 && menuSelect == 2) {
    YBearAdjSlot1(32768);
  }
  if (KeyPadRetrieve() == 7 && menuSelect == 2) {
    YBearAdjSlot2(32768);
  }
  if (KeyPadRetrieve() == 8 && menuSelect == 2) {
    menuSelect = 1;
  }
...
void RunCircleMillmm (long cirSpeed, float xCentermm, float yCentermm, float diameter, float toolDiam, bool internal, float cycles){
  ...
  Serial.print(radStep, 4);
  Serial.print("  cirSpeed = ");
  Serial.print(cirSpeed);
...
void LineMill (long xLMSpeed, float xLMDestination_mm, long yLMSpeedNU, float yLMDestination_mm, long zLMSpeed, long zLMDestination){ // Mill or move from one point to another with interpollation (ALL Axes reach target at same time)
 ...
 // long zLinPos_m2 = 0;
  ...
  Serial.print("xDispOff = ");
  Serial.print(xDisplayOffset);
  Serial.print("  yDispOff = ");
  Serial.print(yDisplayOffset);
  Serial.print("  xLMDest = ");
  Serial.print(xLMDestination);
  Serial.print("  yLMDest = ");
  Serial.print(yLMDestination);
  
  xLinPos_m1 = xTab_m1;
  yLinPos_m0 = yTab_m0;
  
  Serial.print("  xLinPos = ");
  Serial.print(xLinPos_m1);
  Serial.print("  yLinPos = ");
  Serial.print(yLinPos_m0);
  ...
  Serial.print("  xDelta_m1 = ");
  Serial.print(xDelta_m1);
  Serial.print("  yDelta_m0 = ");
  Serial.print(yDelta_m0);
...
void PerspexCut (long perspexSpeed){
      ...
      LineMill(16384,10,16384,0,0,0);
      LineMill(16384,10,16384,10,0,0);
      LineMill(16384,0,16384,10,0,0);
      LineMill(16384,0,16384,0,0,0);
...
void YAxisBase (long feedSpeed){
  while (KeyPadRetrieve() < 12){
  }
  // Cutting path

  lcd1.setCursor(0, 0);
  lcd1.print("  Y-Axis Cut Path   ");
  lcd1.setCursor(0, 3);
  lcd1.print("        Mill        ");
  MoveHold();
  LineMill (feedSpeed,-3,feedSpeed,-1.5,0,0);
  LineMill (feedSpeed,-1.5,feedSpeed,-1.5,0,0);
  LineMill (feedSpeed,169.5,feedSpeed,-1.5,0,0);
  LineMill (feedSpeed,169.5,feedSpeed,39.5,0,0);
  LineMill (feedSpeed,119.5,feedSpeed,39.5,0,0);
  LineMill (feedSpeed,119.5,feedSpeed,49.5,0,0);
  LineMill (feedSpeed,92.5,feedSpeed,49.5,0,0);
  LineMill (feedSpeed,92.5,feedSpeed,134.5,0,0);
  LineMill (feedSpeed,-1.5,feedSpeed,134.5,0,0);
  LineMill (feedSpeed,-1.5,feedSpeed,-1.5,0,0);
  LineMill (feedSpeed,-3,feedSpeed,-1.5,0,0);

  // Part line, do not cut

/*
  lcd1.setCursor(0, 0);
  lcd1.print("  Y-Axis Part Edge  ");
  lcd1.setCursor(0, 3);
  lcd1.print("        Run         ");
  MoveHold();
  GlobalMovemm (300000,0,300000,0,0,0,1);
  GlobalMovemm (300000,168,300000,0,0,0,0);
  GlobalMovemm (300000,168,300000,38,0,0,0);
  GlobalMovemm (300000,118,300000,38,0,0,0);
  GlobalMovemm (300000,118,300000,48,0,0,0);
  GlobalMovemm (300000,91,300000,48,0,0,0);
  GlobalMovemm (300000,91,300000,133,0,0,0);
  GlobalMovemm (300000,0,300000,133,0,0,0);
  GlobalMovemm (300000,0,300000,0,0,0,0);
*/
}

void YBaseMountHoles(long feedSpeed){
  while (KeyPadRetrieve() < 12){
  }  
  // Drill Mounting Holes

  lcd1.setCursor(0, 0);
  lcd1.print(" Y-Axis Mount Holes ");
  lcd1.setCursor(0, 3);
  lcd1.print("     First Hole     ");
  MoveHold();
  GlobalMovemm (feedSpeed,20,feedSpeed,4,0,0,1);
  lcd1.setCursor(0, 3);
  lcd1.print("      Next Hole     ");
  MoveHold();
  GlobalMovemm (feedSpeed,94,feedSpeed,4,0,0,0);
  lcd1.setCursor(0, 3);
  lcd1.print("      Next Hole     ");
  MoveHold();
  GlobalMovemm (feedSpeed,148,feedSpeed,4,0,0,0);
  lcd1.setCursor(0, 3);
  lcd1.print("      Next Hole     ");
  MoveHold();
  GlobalMovemm (feedSpeed,4,feedSpeed,33,0,0,0);
  lcd1.setCursor(0, 3);
  lcd1.print("      Next Hole     ");
  MoveHold();
  GlobalMovemm (feedSpeed,103,feedSpeed,43,0,0,0);
  lcd1.setCursor(0, 3);
  lcd1.print("      Next Hole     ");
  MoveHold();
  GlobalMovemm (feedSpeed,87,feedSpeed,90.5,0,0,0);
  lcd1.setCursor(0, 3);
  lcd1.print("      Next Hole     ");
  MoveHold();
  GlobalMovemm (feedSpeed,4,feedSpeed,108,0,0,0);
  lcd1.setCursor(0, 3);
  lcd1.print("      Next Hole     ");
  MoveHold();
  GlobalMovemm (feedSpeed,45.5,feedSpeed,129,0,0,0);
}

void YRotEncSlot (long feedSpeed){
  while (KeyPadRetrieve() < 12){
  }  
  // Rotary Encoder Slot
  
  lcd1.setCursor(0, 0);
  lcd1.print(" Rotary Encoder Slot");
  lcd1.setCursor(0, 3);
  lcd1.print("    Move to Start   ");
  MoveHold();
  GlobalMovemm (300000,36.5,300000,118.5,0,0,1);
  lcd1.setCursor(0, 3);
  lcd1.print("        Mill        ");
  MoveHold();
  LineMill (feedSpeed,53.5,feedSpeed,118.5,0,0);
  LineMill (feedSpeed,53.5,feedSpeed,123.5,0,0);
  LineMill (feedSpeed,36.5,feedSpeed,123.5,0,0);
  LineMill (feedSpeed,36.5,feedSpeed,118.5,0,0);
}

void YMotCblHle (long feedSpeed){
  while (KeyPadRetrieve() < 12){
  }  
  // 12mm Motor Cable Hole
  
  lcd1.setCursor(0, 0);
  lcd1.print("  Motor Cable Hole  ");
  lcd1.setCursor(0, 3);
  lcd1.print("    Move to Start   ");
  MoveHold();
  GlobalMovemm (300000,45.5,300000,54,0,0,1);
  lcd1.setCursor(0, 3);
  lcd1.print("        Mill        ");
  MoveHold();
  RunCircleMillmm (feedSpeed,45.5,54,12,3,true,1);
}

void YBearAdjSlot1 (long feedSpeed){
  while (KeyPadRetrieve() < 12){
  }  
  // Bearing Adjustment Slots

  lcd1.setCursor(0, 0);
  lcd1.print(" Bearing Adj Slot 1 ");
  lcd1.setCursor(0, 3);
  lcd1.print("    Move to Start   ");
  MoveHold();
  GlobalMovemm (300000,57.5,300000,3.5,0,0,1);
  lcd1.setCursor(0, 3);
  lcd1.print("        Mill        ");
  MoveHold();
  LineMill (feedSpeed,72.5,feedSpeed,3.5,0,0);
  LineMill (feedSpeed,72.5,feedSpeed,6.5,0,0);
  LineMill (feedSpeed,57.5,feedSpeed,6.5,0,0);
  LineMill (feedSpeed,57.5,feedSpeed,3.5,0,0);
}

void YBearAdjSlot2 (long feedSpeed){
  while (KeyPadRetrieve() < 12){
  }  
  lcd1.setCursor(0, 0);
  lcd1.print(" Bearing Adj Slot 2 ");
  lcd1.setCursor(0, 3);
  lcd1.print("    Move to Start   ");
  MoveHold();  
  GlobalMovemm (300000,57.5,300000,36.5,0,0,1);
  lcd1.setCursor(0, 3);
  lcd1.print("        Mill        ");
  MoveHold();
  LineMill (feedSpeed,72.5,feedSpeed,36.5,0,0);
  LineMill (feedSpeed,72.5,feedSpeed,39.5,0,0);
  LineMill (feedSpeed,57.5,feedSpeed,39.5,0,0);
  LineMill (feedSpeed,57.5,feedSpeed,36.5,0,0);
}

void YBaseHoles (long feedSpeed){
  while (KeyPadRetrieve() < 12){
  }
  lcd1.setCursor(0, 0);
  lcd1.print(" Y-Axis Clamp Holes  ");
  lcd1.setCursor(0, 3);
  lcd1.print("        Zero         ");
  MoveHold();
  GlobalMovemm (feedSpeed,0,feedSpeed,0,0,0,0);
  lcd1.setCursor(0, 3);
  lcd1.print("     Next Hole      ");
  MoveHold();
  GlobalMovemm (feedSpeed,15,feedSpeed,22.5,0,0,0);
  lcd1.setCursor(0, 3);
  lcd1.print("     Next Hole      ");
  MoveHold();
  GlobalMovemm (feedSpeed,150,feedSpeed,22.5,0,0,0);
  lcd1.setCursor(0, 3);
  lcd1.print("     Next Hole      ");
  MoveHold();
  GlobalMovemm (feedSpeed,15,feedSpeed,73,0,0,0);
  lcd1.setCursor(0, 3);
  lcd1.print("     Next Hole      ");
  MoveHold();
  GlobalMovemm (feedSpeed,30,feedSpeed,73,0,0,0);
  lcd1.setCursor(0, 3);
  lcd1.print("     Next Hole      ");
  MoveHold();
  GlobalMovemm (feedSpeed,15,feedSpeed,112.5,0,0,0);
  lcd1.setCursor(0, 3);
  lcd1.print("     Next Hole      ");
  MoveHold();
  GlobalMovemm (feedSpeed,30,feedSpeed,112.5,0,0,0);
  lcd1.setCursor(0, 3);
  lcd1.print("     LAST Hole      ");
  MoveHold();
  GlobalMovemm (feedSpeed,75,feedSpeed,112.5,0,0,0);
  lcd1.setCursor(0, 3);
  lcd1.print("  Return to Zero    ");
  MoveHold();
  GlobalMovemm (feedSpeed,0,feedSpeed,0,0,0,0);
}
